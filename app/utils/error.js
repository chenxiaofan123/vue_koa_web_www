...
//接口调用异常类
var InterfaceInvokeFail = function (code, msg) {
    this.code = code;
    this.msg = msg;
    PageError.super_.call(this, msg, this.constructor);
};
util.inherits(InterfaceInvokeFail, AbstractError);
InterfaceInvokeFail.prototype.name = 'Interface invoke Error';

module.exports = {
    JsonError: JsonError,
    PageError:PageError,
    InterfaceInvokeFail:InterfaceInvokeFail
}